            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 flex flex-col gap-4">
                            <div class="flex items-center gap-4">
                                <div id="image-preview" class="hidden w-32 h-32 rounded-lg bg-gray-100 border border-gray-200 overflow-hidden relative flex-shrink-0">
                                ...
                                <div class="flex-grow space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="url" name="thumbnail_url" id="thumbnail_url" placeholder="https://example.com/image.jpg" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ old('thumbnail_url') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" id="content" rows="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('content') }}</textarea>
                    ...
                    <div class="mb-6 flex items-center">
                        <input type="checkbox" name="is_published" id="is_published" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" value="1" {{ old('is_published') ? 'checked' : '' }}>
                        <label for="is_published" class="ml-2 block text-sm text-gray-900">Publish immediately</label>
                    </div>

                    <div class="mb-6 flex items-center">
                        <input type="checkbox" name="is_locked" id="is_locked" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" value="1" {{ old('is_locked', true) ? 'checked' : '' }}>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700">Create Post</button>
                    </div>
                </form>
            </div>
        </div>
