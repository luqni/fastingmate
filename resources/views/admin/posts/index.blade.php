                            ...
                            <tr class="bg-white border-b hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('posts.show', $post) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800 font-medium text-sm flex items-center gap-1" title="View article in frontend">
