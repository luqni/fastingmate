    ...
    <div class="min-h-screen">
            ...
            <header class="sticky top-0 z-30 glass border-b border-gray-100/50 h-20 flex justify-center shadow-sm">
                <div class="w-full max-w-7xl mx-auto px-6 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('documentation') }}" class="p-2 rounded-xl text-gray-400 hover:text-primary-600 hover:bg-primary-50 transition-all" title="Panduan & Dokumentasi">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        </a>
                        ...
                        @auth
                        <a href="{{ route('profile.edit') }}" id="profile-icon" class="p-2 rounded-xl text-gray-400 hover:text-primary-600 hover:bg-primary-50 transition-all" title="Profil & Pengaturan">
        ...
        <nav class="fixed bottom-0 left-0 right-0 glass border-t border-gray-100 z-40 flex justify-center items-center h-24 px-6 shadow-[0_-4px_30px_-4px_rgba(0,0,0,0.1)]">
            <div class="w-full max-w-md md:max-w-4xl flex justify-around items-center">
                ...
                <a href="{{ Auth::check() ? route('fasting-debts.index') : route('login') }}" class="flex flex-col items-center justify-center w-full h-full space-y-2 group">
                ...
                <a href="{{ Auth::check() ? route('fidyah.index') : route('login') }}" class="flex flex-col items-center justify-center w-full h-full space-y-2 group">
                ...
                <a href="{{ Auth::check() ? route('fasting-plans.index') : route('login') }}" class="flex flex-col items-center justify-center w-full h-full space-y-2 group">
                ...
                @elseif(!Auth::check())
                <a href="{{ route('login') }}" class="flex flex-col items-center justify-center w-full h-full space-y-2 group">
                     <div class="relative p-2 rounded-xl transition-all duration-300 text-gray-500 group-hover:bg-gray-50 group-hover:text-gray-700">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2C12 2 5.05 10.95 5.05 15.3C5.05 19 8.15 22 12 22C15.85 22 18.95 19 18.95 15.3C18.95 10.95 12 2 12 2Z"></path></svg>
                     </div>
                    <span class="text-[11px] font-bold text-gray-500 group-hover:text-gray-700">Siklus</span>
                </a>
                @endif
            </div>
        </nav>
    ...
    <div id="di-container" 
        ...
        <div id="di-wrapper" 
            ...
            <div id="di-expanded" class="hidden opacity-0 translate-y-4 transition-all duration-300 ease-out flex-col w-full">
                ...
                <div class="space-y-4">
                    <div class="relative">
                        <div class="block w-full rounded-2xl bg-white/5 border-transparent text-gray-400 p-4 text-sm italic">
                            Masuk untuk menulis dan menyimpan refleksi Anda...
                        </div>
                    </div>
                    <a href="{{ route('login') }}" class="w-full py-4 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 text-white font-bold text-sm">
                        <span>Masuk untuk Refleksi</span>
